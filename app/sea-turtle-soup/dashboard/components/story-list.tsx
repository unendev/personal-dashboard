              ...
              <div className="flex justify-between items-start mb-2">
                ...
                <div className="flex items-center gap-1">
                  {storyState === 'completed' && (
                    <CheckCircle className="h-4 w-4 text-green-700 dark:text-green-400" aria-label="已完成" />
                  )}
                  {storyState === 'favorited' && (
                    <Star className="h-4 w-4 text-yellow-700 dark:text-yellow-400 fill-yellow-700 dark:fill-yellow-400" aria-label="已收藏" />
                  )}
                  <span
